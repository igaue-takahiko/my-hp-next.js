...
const ContactPage = () => {
    return (
        <Layout title="Contact">
            <div className="gb-white text-center shadow-xl p-8 w-80">
                <div className="mt-4">
                    <p className="font-bold">Contact info</p>
                </div>
                <div className="flex justify-center mt-4">
                    <Image
                        className="rounded-full" src="/images/my-image.jpeg"
                        width={180} height={180} alt="Avatar"
                    />
                </div>
                <div className="mt-4">
                ...
                <div className="mt-6 flex justify-around">
                    <div>
                        <a href="http://twitter.com/takahiko_igaue"
                            target="_blank"
                    ...
                    <div>
                        <a
                            href="https://github.com/igaue-takahiko"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                        <svg
